    ...
    <div className="locations">
      ...
      {!clicked ? null : (
        <div>
          ...
          <button value="name">Sort by Name</button>
          {/* onClick={handleSort}
            Sort by Name</button> */}
          <button value="climate">Sort by Climate</button>
          {/* onClick={handleSort}
            Sort by Climate</button> */}
          <button value="terrain">Sort by Terrain</button>
          {/* onClick={handleSort}
          ...
          <ul className="locations-data">
            {sortedLocations &&
              sortedLocations.map((locationData) => {
                return <li><LocationCard locationData={locationData} key={locationData.id} /></li>;
              })}
          </ul>
        </div>
      )}
